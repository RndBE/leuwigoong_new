			...
			<div class="col-md-3 col-xxl-2"  id="target">
				<div class="row row-cards">
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								<div class="subheader"><label class="form-label">Pilih Pos IPCAM</label></div>
								<div class="h3 m-0"> 
									<?php  
									echo form_open('ipcam/set_pos');?>
									<select type="text" name="pilihpos" class="form-select" placeholder="Pilih Pos IPCAM" onchange="this.form.submit()" id="select-pos" value=" ">
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									...
									<?php  
	echo form_open('ipcam/set_parameter');?>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									...
									<?php echo form_open('ipcam/settgl') ;?>
									<div class="row">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<?php echo form_open('ipcam/sesi_data');?>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('ipcam/setbulan') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="input-icon">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('ipcam/settahun') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="input-icon">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('ipcam/setrange') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="row">
												<div class="col-12 col-md-12 col-sm-12">
