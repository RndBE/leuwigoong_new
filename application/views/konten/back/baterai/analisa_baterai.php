			...
			<div class="col-md-3 col-xxl-2"  id="target">
				<div class="row row-cards">
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								<div class="subheader"><label class="form-label">Pilih Pos Baterai</label></div>
								<div class="h3 m-0"> 
									<?php  
									echo form_open('baterai/set_pos');?>
									<select type="text" name="pilihpos" class="form-select" placeholder="Pilih Pos Baterai" onchange="this.form.submit()" id="select-pos" value=" ">
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									...
									<?php  
	echo form_open('baterai/set_parameter');?>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									...
									<?php echo form_open('baterai/settgl') ;?>
									<div class="row">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<?php echo form_open('baterai/sesi_data');?>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('baterai/setbulan') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="input-icon">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('baterai/settahun') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="input-icon">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('baterai/setrange') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="row">
												<div class="col-12 col-md-12 col-sm-12">
...
<?php 
					//$akum = number_format($dataharian->$dtakum,1);
				if($this->session->userdata('kolom') == 'sensor8' && $this->session->userdata('data')=='hari')
				{
					$where=array(
							'code_logger'=>	$this->session->userdata('idlogger'),
							'waktu >='=>$this->session->userdata('pada').' 00:00',
							'waktu <='=>$this->session->userdata('pada').' 23:59',
							);
					$dt_akum=$this->db->select_max('sensor9')->where($where)->get($this->session->userdata('tabel'))->row();
						...
						<div class="card card-sm">
							<div class="card-body">
								<div class="row align-items-center">
									<div class="col-auto">
										<span class="form-control w-100 rounded text-white" style="background-color:#1ea6e0">
								...
								<div class="col">
									...
									<div class="h1 mb-0 me-2 mt-0"><?php echo round($dt_akum->sensor9,2) ?> mm</div>
								</div>
							</div>
						</div>
					</div>
